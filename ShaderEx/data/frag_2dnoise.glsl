...
void main() {
    ...
    float r = multy_scale_noise(rel_pixel_pos + 0.07 * rel_mouse_pos, rel_mouse_pos) + sin(u_time);
    float g = multy_scale_noise(rel_pixel_pos + 0.09 * rel_mouse_pos.yx, rel_mouse_pos) + sin(u_time);
    float b = multy_scale_noise(rel_pixel_pos - 0.01 * rel_mouse_pos, rel_mouse_pos) + sin(u_time);
